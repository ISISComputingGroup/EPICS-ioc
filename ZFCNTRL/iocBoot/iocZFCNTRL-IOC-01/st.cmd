...
dbLoadRecords("$(TOP)/db/zfcntrl.db", "P=$(P),DISABLE=$(DISABLE=0),MAGNETOMETER=$(MAGNETOMETER=not_set),FEEDBACK=$(FEEDBACK=0)")

dbLoadRecords("$(TOP)/db/zfcntrl_axis.db", "P=$(P),MAGNETOMETER=$(MAGNETOMETER=not_set),PSU_X=$(PSU_X=not_set),PSU_Y=$(PSU_Y=not_set),PSU_Z=$(PSU_Z=not_set),OUTPUT_X_MIN=$(OUTPUT_X_MIN=0),OUTPUT_X_MAX=$(OUTPUT_X_MAX=0),OUTPUT_Y_MIN=$(OUTPUT_Y_MIN=0),OUTPUT_Y_MAX=$(OUTPUT_Y_MAX=0),OUTPUT_Z_MIN=$(OUTPUT_Z_MIN=0),OUTPUT_Z_MAX=$(OUTPUT_Z_MAX=0),AMPS_PER_MG_X=$(AMPS_PER_MG_X=0),AMPS_PER_MG_Y=$(AMPS_PER_MG_Y=0),AMPS_PER_MG_Z=$(AMPS_PER_MG_Z=0)")
