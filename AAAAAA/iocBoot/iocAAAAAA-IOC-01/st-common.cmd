epicsEnvSet "STREAM_PROTOCOL_PATH" "$(AAAAAA)/data"
...
dbLoadRecords("$(AAAAAA)/db/none.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
