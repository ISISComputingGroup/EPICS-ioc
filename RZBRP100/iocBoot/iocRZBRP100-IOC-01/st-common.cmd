epicsEnvSet "STREAM_PROTOCOL_PATH" "$(RZBRP100)/data"
...
dbLoadRecords("$(RZBRP100)/db/rzbrp100.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
