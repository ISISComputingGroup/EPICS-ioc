...
#=============================
# Build the IOC application TRANTECH-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# TRANTECH-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# TRANTECH-IOC-01.dbd will be made up from these files:
