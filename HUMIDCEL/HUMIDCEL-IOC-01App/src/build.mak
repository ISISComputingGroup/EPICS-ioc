...
#=============================
# Build the IOC application HUMIDCEL-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# HUMIDCEL-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# HUMIDCEL-IOC-01.dbd will be made up from these files:
...
# HUMIDCEL-IOC-01_registerRecordDeviceDriver.cpp derives from HUMIDCEL-IOC-01.dbd
