epicsEnvSet "STREAM_PROTOCOL_PATH" "$(HUMIDCEL)/data"
...
dbLoadRecords("$(HUMIDCEL)/db/humiditycell.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
