...
dbLoadRecords("$(ADPLUGINKAFKA)/db/ADPluginKafka.template", "P=$(MYPVPREFIX),R=DAE:AD$(LVDET):KFK:,PORT=AD$(LVDET)KFK,ADDR=0,TIMEOUT=1,NDARRAY_PORT=AD$(LVDET)RawImage1,ENABLED=1")
