...
dbLoadRecords("$(ISISDAE)/db/isisdae.db","S=$(MYPVPREFIX), P=$(MYPVPREFIX), Q=$(Q), WIRINGLIST=WLIST, DETECTORLIST=DLIST, SPECTRALIST=SLIST, PERIODLIST=PLIST, TCBLIST=TLIST, BEGINRUNA=$(BEGINRUN_DAE3=$(MYPVPREFIX)$(Q)_BEGINRUN1), ENDRUNA=$(ENDRUN_DAE3=$(MYPVPREFIX)$(Q)_ENDRUN1),POST_BEGIN_1=$(POST_BEGIN_1=),POST_BEGIN_2=$(POST_BEGIN_2=),POST_BEGIN_3=$(POST_BEGIN_3=),POST_BEGIN_4=$(POST_BEGIN_4=),POST_END_1=$(POST_END_1=),POST_END_2=$(POST_END_2=),POST_END_3=$(POST_END_3=),POST_END_4=$(POST_END_4=)")
