...
dbLoadRecords("$(TOP)/db/alertAction.db","P=$(MYPVPREFIX),Q=CS:AC:ALERTS:ACTION:OUT,SOURCE=$(MYPVPREFIX)CS:AC:OUT:LIST,MESS=out of range,ACTION=$(MYPVPREFIX)CS:AC:ALERTS:MESSAGE:SP")
dbLoadRecords("$(TOP)/db/alertAction.db","P=$(MYPVPREFIX),Q=CS:AC:ALERTS:ACTION:IN,SOURCE=$(MYPVPREFIX)CS:AC:OUT:LIST,MESS=all back in range,ACTION=$(MYPVPREFIX)CS:AC:ALERTS:MESSAGE:SP")
dbLoadRecords("$(TOP)/db/runcontrolMgr.db","P=$(MYPVPREFIX),ALERT_OUT=$(MYPVPREFIX)CS:AC:ALERTS:ACTION:OUT:DO.PROC,ALERT_IN=$(MYPVPREFIX)CS:AC:ALERTS:ACTION:IN:DO.PROC,ALERT_CHANGE=$(MYPVPREFIX)CS:AC:ALERTS:ACTION:OUT:DO.PROC")
