epicsEnvSet "STREAM_PROTOCOL_PATH" "$(WBVALVE)/data"
...
dbLoadRecords("$(WBVALVE)/db/wbvalve.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
