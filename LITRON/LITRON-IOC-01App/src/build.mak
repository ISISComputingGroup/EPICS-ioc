...
#=============================
# Build the IOC application LITRON-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# LITRON-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# LITRON-IOC-01.dbd will be made up from these files:
...
# LITRON-IOC-01_registerRecordDeviceDriver.cpp derives from LITRON-IOC-01.dbd
