epicsEnvSet "STREAM_PROTOCOL_PATH" "$(KHLY6517)/data"
...
dbLoadRecords("$(KHLY6517)/db/khly6517.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
