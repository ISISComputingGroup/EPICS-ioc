epicsEnvSet "STREAM_PROTOCOL_PATH" "$(MECFRF)/data"
...
dbLoadRecords("$(MECFRF)/db/mecfrf.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,IOCNAME=$(IOCNAME),RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
