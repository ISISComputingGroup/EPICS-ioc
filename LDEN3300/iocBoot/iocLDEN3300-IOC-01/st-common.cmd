epicsEnvSet "STREAM_PROTOCOL_PATH" "$(LDEN3300)/data"
...
dbLoadRecords("$(LDEN3300)/db/ldens3300.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE),IOCNAME=$(IOCNAME)")
