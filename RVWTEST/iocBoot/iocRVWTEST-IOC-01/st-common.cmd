epicsEnvSet "STREAM_PROTOCOL_PATH" "$(RVWTEST)/data"
...
dbLoadRecords("$(RVWTEST)/db/rvwtest.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
