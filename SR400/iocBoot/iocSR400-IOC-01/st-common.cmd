epicsEnvSet "STREAM_PROTOCOL_PATH" "$(SR400)/data"
...
dbLoadRecords("$(SR400)/db/stanford_sr400_photon_counter.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
