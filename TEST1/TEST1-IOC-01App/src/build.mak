...
#=============================
# Build the IOC application TEST1-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# TEST1-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# TEST1-IOC-01.dbd will be made up from these files:
...
# TEST1-IOC-01_registerRecordDeviceDriver.cpp derives from TEST1-IOC-01.dbd
