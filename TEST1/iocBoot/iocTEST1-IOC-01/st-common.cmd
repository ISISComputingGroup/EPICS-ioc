epicsEnvSet "STREAM_PROTOCOL_PATH" "$(TEST1)/data"
...
dbLoadRecords("$(TEST1)/db/test1.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
