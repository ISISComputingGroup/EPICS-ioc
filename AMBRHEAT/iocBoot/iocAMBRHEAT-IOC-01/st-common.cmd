epicsEnvSet "STREAM_PROTOCOL_PATH" "$(AMBRHEAT)/data"
...
dbLoadRecords("$(AMBRHEAT)/db/ambrell_easy_heat.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
