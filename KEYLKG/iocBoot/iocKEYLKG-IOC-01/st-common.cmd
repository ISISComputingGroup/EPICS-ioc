epicsEnvSet "STREAM_PROTOCOL_PATH" "$(KEYLKG)/data"
...
dbLoadRecords("$(KEYLKG)/db/keylkg.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
