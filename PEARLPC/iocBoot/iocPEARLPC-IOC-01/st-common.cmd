...
dbLoadRecords("$(UTILITIES)/db/disable_pv_puts.db", "INST=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,PV1=$(MYPVPREFIX)$(IOCNAME):PRESSURE:SP,PV2=$(MYPVPREFIX)$(IOCNAME):USER_LIMIT:SP,PV3=$(MYPVPREFIX)$(IOCNAME):LIMITS:POS_CHANGE:SP,PV4=$(MYPVPREFIX)$(IOCNAME):LIMITS:POS_OFFSET:SP,PV5=$(MYPVPREFIX)$(IOCNAME):LIMITS:NEG_CHANGE:SP,PV6=$(MYPVPREFIX)$(IOCNAME):LIMITS:NEG_OFFSET:SP,PV7=$(MYPVPREFIX)$(IOCNAME):PRESSURE_DIFF_THOLD:SP")
