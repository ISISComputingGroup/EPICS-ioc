...
dbLoadRecords("$(SEPRTR)/db/separator_stability.db","P=$(MYPVPREFIX)$(IOCNAME):, PORT=$(DEVICE), DISABLE=$(DISABLE=0),RECSIM=$(RECSIM=0), NELM=$(NELM=100), FREQ=$(FREQ=1000), VUPPERLIM=$(VUPPERLIM=1), VLOWERLIM=$(VLOWERLIM=0), ISTEADY=$(ISTEADY=0), ILIMIT=$(ILIMIT=1), WINDOWSIZE=$(WINDOWSIZE=600), MAXUNSTBL=$(MAXUNSTBL=30), FILTEREDLEN=$(FILTEREDLEN)")
