...
dbLoadRecords("$(HLX503)/db/hlx503.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE),HE3POT_HIGHT_ISOBUS=$(HE3POT_HIGHT_ISOBUS),HE3POT_LOWT_ISOBUS=$(HE3POT_LOWT_ISOBUS),1KPOT_ISOBUS=$(1KPOT_ISOBUS),SORB_ISOBUS=$(SORB_ISOBUS)")
