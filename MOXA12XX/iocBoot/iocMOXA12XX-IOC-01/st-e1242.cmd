...
#drvModbusAsynConfigure("$(E12XX_ASYNPORT)_DO", "$(E12XX_ASYNPORT)", 0, 5, 0x0,   0x4, 0,   1, "ioLogik")

# MOXA E1242 DOs: function 1 (Read Coils), address 0x0, length 0x4, data_type = UINT16 = 0, # pollMsec = for read func, waits XXX msecs
#drvModbusAsynConfigure("$(E12XX_ASYNPORT)_DO_RBV", "$(E12XX_ASYNPORT)", 0, 1, 0x0,   0x4, 0, 100, "ioLogik")
