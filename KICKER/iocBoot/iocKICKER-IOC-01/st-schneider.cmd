...
dbLoadRecords("$(KICKER)/db/kicker_power.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,IFNOTRECSIM=$(IFNOTRECSIM),RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE), DEVICE=$(DEVICE)")
