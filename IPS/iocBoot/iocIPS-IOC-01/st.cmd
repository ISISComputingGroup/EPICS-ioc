...
$(IFNOTSTREAMPROTOCOL_SCPI) seq cryomagnet, "FIELD=$(P)FIELD,FIELD_SETPOINT=$(P)FIELD:SP,FIELD_SETPOINT_ALARM=$(P)FIELD:SP.SEVR,FIELD_SETPOINT_READBACK=$(P)FIELD:SP:RBV,FIELD_SETPOINT_RAW=$(P)FIELD:SP:_RAW,PERSISTENT=$(P)PERSISTENT,MAGNET_FIELD=$(P)MAGNET:FIELD:PERSISTENT,HEATER_STATUS=$(P)HEATER:STATUS,HEATER_STATUS_SP=$(P)HEATER:STATUS:SP,HEATER_WAIT_TIME=$(P)HEATER:WAITTIME,ACTIVITY=$(P)ACTIVITY,ACTIVITY_SP=$(P)ACTIVITY:SP,SWEEPMODE=$(P)SWEEPMODE:PARAMS,SWEEPMODE_SP=$(P)SWEEPMODE:PARAMS:SP,SUPPLYVOLTAGE_STABLE=$(P)SUPPLY:VOLT:STABLE,SWEEP_ACTIVE=$(P)STS:SWEEPMODE:SWEEP,STATEMACHINE=$(P)STATEMACHINE,HEATER_ONTIME_OK=$(P)HEATER:ONTIME_OK")
$(IFSTREAMPROTOCOL_SCPI) seq cryomagnet_SCPI, "FIELD=$(P)FIELD,FIELD_SETPOINT=$(P)FIELD:SP,FIELD_SETPOINT_ALARM=$(P)FIELD:SP.SEVR,FIELD_SETPOINT_READBACK=$(P)FIELD:SP:RBV,FIELD_SETPOINT_RAW=$(P)FIELD:SP:_RAW,PERSISTENT=$(P)PERSISTENT,MAGNET_FIELD=$(P)MAGNET:FIELD:PERSISTENT,HEATER_STATUS=$(P)HEATER:STATUS,HEATER_STATUS_SP=$(P)HEATER:STATUS:SP,HEATER_WAIT_TIME=$(P)HEATER:WAITTIME,ACTIVITY=$(P)ACTIVITY,ACTIVITY_SP=$(P)ACTIVITY:SP,SWEEPMODE=$(P)SWEEPMODE:PARAMS,SUPPLYVOLTAGE_STABLE=$(P)SUPPLY:VOLT:STABLE,SWEEP_ACTIVE=$(P)STS:SWEEPMODE:SWEEP,STATEMACHINE=$(P)STATEMACHINE,HEATER_ONTIME_OK=$(P)HEATER:ONTIME_OK")
