epicsEnvSet "STREAM_PROTOCOL_PATH" "$(TRANSTEC)/data"
...
dbLoadRecords("$(TRANSTEC)/db/transtec.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
