...
IOCDIRS += MCLEN MERCURY_ITC MERCURY_CRYO MK2CHOPR MK3CHOPR NANODAC NEOCERA PDR2000 PIMOT PSCTRL 
...
IOCDIRS += SP2XX RKNDIO NGPSPSU KYNCTM3K MOXA1210 INDFURN SEPRTR
...
DIRS_NOTBUILD += MK3CHOPR ECLAB GALIL HIFIMAG INSTRON SECI2IBEX FERMCHOP RKNPS SEPRTR
endif
...
ifneq ($(HAVE_ATL),YES)  
DIRS_NOTBUILD += ISISDAE MERCURY_ITC MERCURY_CRYO STPS350 AG53220A STSR400 DELFTSHEAR DELFTDCMAG DELFTARDUSTEP LVTEST SCIMAG3D HIFIMAG SAMPOS EGXCOLIM COUETTE
endif
