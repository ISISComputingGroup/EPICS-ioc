...
IOCDIRS += ROTSC AMINT2L SPRLG SAMPOS
...
ifneq ($(HAVE_ATL),YES)  
DIRS_NOTBUILD += ISISDAE MERCURY_ITC STPS350 AG53220A STSR400 DELFTSHEAR DELFTDCMAG DELFTARDUSTEP LVTEST SCIMAG3D HIFIMAG INSTRON SAMPOS
endif
