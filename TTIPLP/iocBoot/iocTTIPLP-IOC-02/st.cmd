...
dbLoadDatabase "dbd/TTIPLP-IOC-02.dbd"
...
dbLoadRecords("$(TTIPLP)/db/ttiplp.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
