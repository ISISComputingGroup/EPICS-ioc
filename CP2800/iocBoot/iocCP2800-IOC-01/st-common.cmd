epicsEnvSet "STREAM_PROTOCOL_PATH" "$(CP2800)/data"
...
dbLoadRecords("$(CP2800)/db/cp2800.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
