...
dbLoadRecords("$(HELIOX)/db/heliox_channel.db","P=$(MYPVPREFIX)$(IOCNAME):,PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PROTO=$(PROTO=heliox.proto),NAME=HEHIGH,PROTOCOL_NAME=$(HEHIGH_NAME=HeHigh),STABILITY=#")
dbLoadRecords("$(HELIOX)/db/heliox_channel.db","P=$(MYPVPREFIX)$(IOCNAME):,PORT=L0,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PROTO=$(PROTO=heliox.proto),NAME=HELOW,PROTOCOL_NAME=$(HELOW_NAME=HeLow),STABILITY=#")
