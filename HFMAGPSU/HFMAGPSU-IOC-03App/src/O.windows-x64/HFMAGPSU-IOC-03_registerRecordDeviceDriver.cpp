...
/* Generated from ../O.Common/HFMAGPSU-IOC-03.dbd */
...
int HFMAGPSU_IOC_03_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* HFMAGPSU_IOC_03_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"HFMAGPSU_IOC_03_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    HFMAGPSU_IOC_03_registerRecordDeviceDriver(*iocshPpdbbase);
}
