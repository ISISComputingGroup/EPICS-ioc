...
/* Generated from ../O.Common/HFMAGPSU-IOC-01.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devSiSeq,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiGeneralTime", "devAiStats", "devAiClusts", "devaiStream",
    ...
    "devBiSoftCallback", "devBiDbState", "devbiStream", "asynBiInt32",
    ...
    "devSiEnviron", "devSiSeq", "devStringinStats", "devStringinEnvVar",
    "devStringinEpics", "devstringinStream", "asynSiOctetCmdResponse",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devSiSeq, pvar_dset_devStringinStats,
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_dbLoadRecordsFuncsRegister, pvar_func_dbndInitialize,
    ...
    pvar_func_freeIPPortRegister, pvar_func_icpInitHooksRegister,
    pvar_func_icpconfigRegister, pvar_func_ioccalcRegister,
    pvar_func_iocdcalcRegister, pvar_func_iocnameRegister,
    pvar_func_iocshCmdFuncsRegister, pvar_func_iocstringtestRegister,
    pvar_func_mkdirRegister, pvar_func_pvdumpRegister,
...
int HFMAGPSU_IOC_01_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "C:/Instrument/Apps/EPICS/ioc/master/HFMAGPSU";
    ...
    pvar_func_dbLoadRecordsFuncsRegister();
    pvar_func_dbndInitialize();
    pvar_func_dbrestoreRegister();
    pvar_func_drvAsynIPPortRegisterCommands();
    pvar_func_drvAsynIPServerPortRegisterCommands();
    pvar_func_drvAsynSerialPortRegisterCommands();
    pvar_func_freeIPPortRegister();
    pvar_func_icpInitHooksRegister();
    pvar_func_icpconfigRegister();
    pvar_func_ioccalcRegister();
    pvar_func_iocdcalcRegister();
    pvar_func_iocnameRegister();
    pvar_func_iocshCmdFuncsRegister();
    pvar_func_iocstringtestRegister();
    pvar_func_mkdirRegister();
    pvar_func_pvdumpRegister();
...
/* HFMAGPSU_IOC_01_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"HFMAGPSU_IOC_01_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    HFMAGPSU_IOC_01_registerRecordDeviceDriver(*iocshPpdbbase);
}
