epicsEnvSet "STREAM_PROTOCOL_PATH" "$(KHLY2290)/data"
...
dbLoadRecords("$(KHLY2290)/db/devKeithley2290.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
