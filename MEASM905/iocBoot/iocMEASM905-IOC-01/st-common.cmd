epicsEnvSet "STREAM_PROTOCOL_PATH" "$(MEASM905)/data"
...
dbLoadRecords("$(MEASM905)/db/measm905.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
