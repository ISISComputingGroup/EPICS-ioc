epicsEnvSet "STREAM_PROTOCOL_PATH" "$(KNRK6)/data"
...
stringiftest("SERIAL", "$(COMMS_MODE=serial)", 0x5, "serial")

## For real device:
$(IFNOTSERIAL) $(IFNOTDEVSIM) $(IFNOTRECSIM) drvAsynIPPortConfigure("$(DEVICE)", "$(HOST=NO_HOST_MACRO):10001", 0, 0, 0, 0)
...
dbLoadRecords("$(KNRK6)/db/knrk6.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
