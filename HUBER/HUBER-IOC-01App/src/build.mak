...
#=============================
# Build the IOC application HUBER-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# HUBER-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# HUBER-IOC-01.dbd will be made up from these files:
...
# HUBER-IOC-01_registerRecordDeviceDriver.cpp derives from HUBER-IOC-01.dbd
