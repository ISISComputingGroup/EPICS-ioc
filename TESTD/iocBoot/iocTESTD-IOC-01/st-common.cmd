epicsEnvSet "STREAM_PROTOCOL_PATH" "$(TESTD)/data"
...
dbLoadRecords("$(TESTD)/db/testd.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
