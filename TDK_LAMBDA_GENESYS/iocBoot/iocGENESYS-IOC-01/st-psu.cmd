...
$(IFPORT) dbLoadRecords("$(UTILITIES)/db/check_stability.db", "P=$(MYPVPREFIX)$(IOCNAME):$(PS):,INP_VAL=$(MYPVPREFIX)$(IOCNAME):$(PS):FIELD,SP=$(MYPVPREFIX)$(IOCNAME):$(PS):FIELD:SP:RBV,NSAMP=5,TOLERANCE=$(TOLERANCE$(PS)=0)")
