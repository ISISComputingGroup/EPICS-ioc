...
# Readascii units
$(IFACTIVE) dbLoadRecords("$(ReadASCII)/db/unit_setter.db","DIR=$(P)TEMP,CAL=$(P)CAL:RBV,OUT=$(P)TEMP")
$(IFACTIVE) dbLoadRecords("$(ReadASCII)/db/unit_setter.db","DIR=$(P)TEMP,CAL=$(P)CAL:RBV,OUT=$(P)TEMP:SP")
$(IFACTIVE) dbLoadRecords("$(ReadASCII)/db/unit_setter.db","DIR=$(P)TEMP,CAL=$(P)CAL:RBV,OUT=$(P)TEMP:SP:RBV")
