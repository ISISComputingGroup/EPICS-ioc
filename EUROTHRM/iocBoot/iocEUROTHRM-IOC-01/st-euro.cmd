...
$(IFACTIVE) $(IFNEEDLE_VALVE) dbLoadRecords("$(TOP)/db/automaticNeedleValve.db", "P=$(P),Q=$(MYPVPREFIX)$(IOCNAME):,GAD=$(GAD), LAD=$(LAD), TEMP_SCALING=$(TEMP_SCALING_$(EURO_NUM)=0.01)")
