...
$(IFACTIVE) dbLoadRecords("$(TOP)/db/devEurothrm.db","P=$(P),Q=$(MYPVPREFIX)$(IOCNAME):, ADDR=$(ADDR_$(EURO_NUM)=0), GAD=$(GAD), LAD=$(LAD), PORT=L0, CALIB_BASE_DIR= $(CALIB_BASE_DIR), READ=READASCII$(EURO_NUM), RAMPLIST=RAMPFILELIST$(EURO_NUM), TREAD=$(TREAD=1.4), TDLY=$(TDLY=0.5), IFUSES_BISYNCH=$(IFUSES_BISYNCH),IFNOTUSES_BISYNCH=$(IFNOTUSES_BISYNCH),TEMP_SCALING=$(TEMP_SCALING_$(EURO_NUM)=1.0),P_SCALING=$(P_SCALING_$(EURO_NUM)=1.0)")
