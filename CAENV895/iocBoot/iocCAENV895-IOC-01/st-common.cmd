...
$(IFNOTDEVSIM) $(IFNOTRECSIM) $(IFCRATE0) CAENVMEConfigure("CRATE0", $(MY_BOARD_NUMBER_0), $(CAEN_BOARD_NUMBER_0), $(BASE_ADDRESS_0), 0x10000, 0)
$(IFNOTDEVSIM) $(IFNOTRECSIM) $(IFCRATE1) CAENVMEConfigure("CRATE1", $(MY_BOARD_NUMBER_1), $(CAEN_BOARD_NUMBER_1), $(BASE_ADDRESS_1), 0x10000, 0)
$(IFNOTDEVSIM) $(IFNOTRECSIM) $(IFCRATE2) CAENVMEConfigure("CRATE2", $(MY_BOARD_NUMBER_2), $(CAEN_BOARD_NUMBER_2), $(BASE_ADDRESS_2), 0x10000, 0)
