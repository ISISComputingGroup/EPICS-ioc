...
stringiftest("AUTOSAVESETPOINTS", "$(AUTOSAVESETPOINTS=NO)", 5, "YES")

## Load our record instances
dbLoadRecords("db/ttiEX355P.db","P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM),PORT=L0,AMPSTOGAUSS=$(AMPSTOGAUSS),FIELD_CONV_DEFINED=$(FIELD_CONV_DEFINED),MAX_FIELD=$(MAX_FIELD=1000000000),DISABLE_AUTOONOFF=$(DISABLE_AUTOONOFF=1),OFF_TOLERANCE=$(OFF_TOLERANCE=0.1),IFAUTOSAVESETPOINTS=$(IFAUTOSAVESETPOINTS)")

dbLoadRecords("$(UTILITIES)/db/check_stability.db", "P=$(MYPVPREFIX)$(IOCNAME):,INP_VAL=$(MYPVPREFIX)$(IOCNAME):FIELD,SP=$(MYPVPREFIX)$(IOCNAME):FIELD:SP:RBV,NSAMP=5,TOLERANCE=$(TOLERANCE=0.1)")
