epicsEnvSet "STREAM_PROTOCOL_PATH" "$(DDSSTRES)/data"
...
dbLoadRecords("$(DDSSTRES)/db/dds_stress_rig.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
