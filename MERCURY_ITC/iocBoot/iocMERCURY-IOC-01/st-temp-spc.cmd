...
$(IFVTI_SPC_PRESSURE) dbLoadRecords("$(MERCURY_ITC)/db/MercuryVTISPC.db", "P=$(MYPVPREFIX)$(IOCNAME):,TEMP_CARD=$(TEMP_NUM),PRESSURE_CARD=$(VTI_SPC_PRESSURE_$(TEMP_NUM)=),MIN_PRESSURE=$(VTI_SPC_MIN_PRESSURE=0.0),PRESSURE_CONSTANT=$(VTI_SPC_PRESSURE_CONSTANT=5.0),TEMP_CUTOFF_POINT=$(VTI_SPC_TEMP_CUTOFF_POINT=5.0),RECSIM=$(RECSIM),DISABLE=$(DISABLE)")
