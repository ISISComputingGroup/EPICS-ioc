...
dbLoadRecords("$(MERCURY_ITC)/db/MercurySPCAvailable.db", "P=$(MYPVPREFIX)$(IOCNAME):,TEMP_CARD=$(TEMP_NUM),IFFLOW_SPC_PRESSURE_$(TEMP_NUM)=$(IFFLOW_SPC_PRESSURE_$(TEMP_NUM)),IFNOTFLOW_SPC_PRESSURE_$(TEMP_NUM)=$(IFNOTFLOW_SPC_PRESSURE_$(TEMP_NUM)),IFVTI_SPC_PRESSURE_$(TEMP_NUM)=$(IFVTI_SPC_PRESSURE_$(TEMP_NUM)),IFNOTVTI_SPC_PRESSURE_$(TEMP_NUM)=$(IFNOTVTI_SPC_PRESSURE_$(TEMP_NUM))")
