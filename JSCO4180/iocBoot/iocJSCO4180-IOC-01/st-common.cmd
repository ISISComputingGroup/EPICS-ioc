...
seq detect_jasco_error_state, "SETPOINT=$(P)COMP:A:SP,READBACK=$(P)COMP:A,STATUS=$(P)STATUS,PUMPRUN=$(P)START:SP,TIMERUN=$(P)TIMED:SP,PUMPSTOP=$(P)STOP:SP,MODE=$(P)TIME:MODE,ERROR=$(P)ERROR:COMP,TOLERANCE=$(P)ERROR:TOL,DELAY=$(P)ERROR:DELAY"
