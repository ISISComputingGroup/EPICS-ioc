epicsEnvSet "STREAM_PROTOCOL_PATH" "$(HEGAUGE)/data"
...
dbLoadRecords("$(HEGAUGE)/db/hegauge.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
