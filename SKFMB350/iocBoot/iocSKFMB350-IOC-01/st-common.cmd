...
dbLoadRecords("db/chopper.db","P=$(MYPVPREFIX)$(IOCNAME):, PORT=L0, RECSIM=$(RECSIM=0), DISABLE=$(DISABLE=0),PARKPOS=$(PARKPOS=1),PARKOPEN=$(PARKOPEN=0),PARKCLOSED=$(PARKCLOSED=0)")
