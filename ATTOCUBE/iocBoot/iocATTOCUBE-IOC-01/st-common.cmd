epicsEnvSet "STREAM_PROTOCOL_PATH" "$(ATTOCUBE)/data"
...
dbLoadRecords("$(ATTOCUBE)/db/attocube.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
