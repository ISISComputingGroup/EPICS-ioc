epicsEnvSet "STREAM_PROTOCOL_PATH" "$(BBBBB)/data"
...
dbLoadRecords("$(BBBBB)/db/aabcdef.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
