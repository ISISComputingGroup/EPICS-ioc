...
dbLoadRecords("NDStdArrays.template", "P=$(MYPVPREFIX),R=$(IOCNAME):D$(DIG):AD$(LVDET):IM1:,PORT=AD$(DIG)$(LVDET)IM1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=AD$(DIG)$(LVDET)ROI1,NDARRAY_ADDR=0,DATATYPE=$(DATATYPE=9),ENABLED=1,TYPE=$(TYPE=Float64),FTVL=$(FTVL=DOUBLE),NELEMENTS=$(LIVEVIEW_NELEMENTS=1500000)")
