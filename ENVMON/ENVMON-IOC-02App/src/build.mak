...
#=============================
# Build the IOC application ENVMON-IOC-02
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# ENVMON-IOC-02.dbd will be created and installed
DBD += $(APPNAME).dbd

# ENVMON-IOC-02.dbd will be made up from these files:
...
# ENVMON-IOC-02_registerRecordDeviceDriver.cpp derives from ENVMON-IOC-02.dbd
