...
#=============================
# Build the IOC application ENVMON-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# ENVMON-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# ENVMON-IOC-01.dbd will be made up from these files:
...
# ENVMON-IOC-01_registerRecordDeviceDriver.cpp derives from ENVMON-IOC-01.dbd
