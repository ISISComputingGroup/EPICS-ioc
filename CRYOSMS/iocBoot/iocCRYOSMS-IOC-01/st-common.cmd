...
dbLoadRecords("$(CRYOSMS)/db/cryosms.db","P=$(MYPVPREFIX)$(IOCNAME):,PORT=L0,ASYN_PORT=ASYN_PORT,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),WRITE_UNIT=$(WRITE_UNIT),DISPLAY_UNIT=$(DISPLAY_UNIT),T_TO_A=$(T_TO_A),SWITCH_HIGH=$(SWITCH_HIGH),SWITCH_LOW=$(SWITCH_LOW),SWITCH_STABLE_NUMBER=$(SWITCH_STABLE_NUMBER),SWITCH_STABLE_NUMBER_WARM=$(SWITCH_STABLE_NUMBER),SWITCH_TEMP_PV=$(SWITCH_TEMP_PV)")
