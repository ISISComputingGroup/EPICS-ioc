...
dbLoadRecords("$(UTILITIES)/db/check_stability.db", "P=$(MYPVPREFIX)$(IOCNAME):,INP_VAL=$(MYPVPREFIX)$(IOCNAME):RAW,SP=$(MYPVPREFIX)$(IOCNAME):RAW:SP,NSAMP=5,TOLERANCE=$(TOLERANCE=0)")
