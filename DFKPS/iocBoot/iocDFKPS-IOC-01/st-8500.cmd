...
dbLoadRecords("$(TOP)/Db/DFKPS_8500_status.db", "device=$(MYPVPREFIX)$(IOCNAME), P=$(MYPVPREFIX)$(IOCNAME):, port=L0, SP_PINI=$(SP_PINI), ADDRESS=$(ADDRESS), POLCMD=$(POLCMD), MIN_RAW_SETPOINT=$(MIN_RAW_SETPOINT), MAX_RAW_SETPOINT=$(MAX_RAW_SETPOINT)")
