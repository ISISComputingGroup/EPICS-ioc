...
#=============================
# Build the IOC application CATFLWR-IOC-01
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# CATFLWR-IOC-01.dbd will be created and installed
DBD += $(APPNAME).dbd

# CATFLWR-IOC-01.dbd will be made up from these files:
...
# CATFLWR-IOC-01_registerRecordDeviceDriver.cpp derives from CATFLWR-IOC-01.dbd
