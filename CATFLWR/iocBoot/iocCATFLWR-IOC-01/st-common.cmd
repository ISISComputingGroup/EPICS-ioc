epicsEnvSet "STREAM_PROTOCOL_PATH" "$(CATFLWR)/data"
...
dbLoadRecords("$(CATFLWR)/db/catflwr.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
