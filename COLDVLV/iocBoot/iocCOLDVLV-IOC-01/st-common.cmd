epicsEnvSet "STREAM_PROTOCOL_PATH" "$(COLDVLV)/data"
...
dbLoadRecords("$(COLDVLV)/db/coldvlv.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
