...
$(IFGAUGE1) dbLoadRecords("$(EDTIC)/db/edwardsTicGauge.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE),GAUGE=1")
stringiftest("GAUGE2" "$(USEGAUGE2="NO")" 5 "YES")
$(IFGAUGE2) dbLoadRecords("$(EDTIC)/db/edwardsTicGauge.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE),GAUGE=2")
