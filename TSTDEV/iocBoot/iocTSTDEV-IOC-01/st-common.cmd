epicsEnvSet "STREAM_PROTOCOL_PATH" "$(TSTDEV)/data"
...
dbLoadRecords("$(TSTDEV)/db/tstdev.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
