epicsEnvSet "STREAM_PROTOCOL_PATH" "$(LM500)/data"
...
dbLoadRecords("$(LM500)/db/lm500.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
