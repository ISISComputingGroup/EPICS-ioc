...
##  TYPE=Float64,FTVL=DOUBLE,DATATYPE=7 for 64 bit float 
...
dbLoadRecords("NDROI.template", "P=$(MYPVPREFIX),R=$(IOCNAME):AD:roi1:,PORT=ROI1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=RawImage1,NDARRAY_ADDR=0,DATATYPE=7,ENABLED=1")
