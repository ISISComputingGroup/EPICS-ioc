epicsEnvSet "STREAM_PROTOCOL_PATH" "$(SMTOF70)/data"
...
dbLoadRecords("$(SMTOF70)/db/SHI_F-70_RS232_monitor.template","P=$(MYPVPREFIX)$(IOCNAME),RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0),PORT=$(DEVICE)")
