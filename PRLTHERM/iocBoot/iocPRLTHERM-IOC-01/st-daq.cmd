...
epicsEnvSet("DAQMX_OPTIONS", "N=2 F=1 m=$(MIN_TEMP=73.15) M=$(MAX_TEMP=1645.15) U=$(UNITS_DAQMX=Kelvins) thermocoupleType=$(TC_TYPE=K_Type_TC) cjcSource=$(CJC_SOURCE=BuiltIn) cjcVal=$(CJC_VAL=25.0) cjcChannel=$(CJC_CHANNEL=0) AIADCTimingMode=HighResolution AIAutoZeroMode=Once")
