...
#=============================
# Build the IOC application BEAMCORR
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# BEAMCORR.dbd will be created and installed
DBD += $(APPNAME).dbd

# BEAMCORR.dbd will be made up from these files:
...
# BEAMCORR_registerRecordDeviceDriver.cpp derives from BEAMCORR.dbd
