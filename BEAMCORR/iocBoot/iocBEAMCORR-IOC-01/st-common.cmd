...
dbLoadRecords("${TOP}/db/beamcorr.db","PVPREFIX=$(MYPVPREFIX),P=$(MYPVPREFIX)$(IOCNAME):,RECSIM=$(RECSIM=0),DISABLE=$(DISABLE=0), NUM_STEER=$(NUM_STEER), HIFI_PV_MAIN=$(HIFI_PV_MAIN=),HIFI_PV_TRANS_X=$(HIFI_PV_TRANS_X=),HIFI_PV_TRANS_Y=$(HIFI_PV_TRANS_Y=),EMU_PV_MAIN=$(EMU_PV_MAIN=),EMU_PV_TRANS=$(EMU_PV_TRANS=),MUSR_PV_MAIN=$(MUSR_PV_MAIN=),MUSR_PV_TRANS=$(MUSR_PV_TRANS=),IFRECSIM=$(IFRECSIM=), IFNOTRECSIM=$(IFNOTRECSIM=)")
